...
// Timeline para las flores (ya existente)
var tl = gsap.timeline();

// Tus animaciones de flores y demás
tl
  // Ejemplo de animación de flores ya existente
  .fromTo(
    ["#Stem16_1_", "#Stem1_1_"],
    { drawSVG: "0% 0%" },
    { duration: 1.5, drawSVG: "0% 100%" },
  ...
  // Animación del texto sincronizada
  .fromTo(
    "#text-message",
    { autoAlpha: 0, y: 50 },
    { autoAlpha: 1, y: 0, duration: 2 },
    "flower2+=1" // Aparece después de que las flores estén listas
  );
